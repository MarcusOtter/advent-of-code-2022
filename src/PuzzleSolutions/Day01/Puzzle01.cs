...
//     11000 Calories. The fourth Elf is carrying food with 7000, 8000, and 9000 Calories, a total of 24000 Calories.
...
public class Puzzle01 : IPuzzleSolver
{
	public ValueTask<string> SolveFirstHalfAsync(IEnumerable<string> input)
	{
		...
		return ValueTask.FromResult(topCalories.ToString());
	}
